            ...
            <div className="flex-1 overflow-y-auto p-5 md:p-6">
              <div className="mb-4">
                <p className="text-gray-400 text-sm">
                  Valor do produto: <span className="text-white font-bold">R$297,00</span>
                </p>
              </div>

              <div className="space-y-2">
                {[
                  { parcelas: "1x", valor: "R$ 297,00", total: "R$ 297,00", semJuros: true },
                  { parcelas: "2x", valor: "R$ 151,49", total: "R$ 302,98", semJuros: true },
                  { parcelas: "3x", valor: "R$ 102,00", total: "R$ 306,00", semJuros: true },
                  { parcelas: "4x", valor: "R$ 77,25", total: "R$ 309,00", semJuros: true },
                  { parcelas: "5x", valor: "R$ 62,40", total: "R$ 312,00", semJuros: true },
                  { parcelas: "6x", valor: "R$ 52,50", total: "R$ 315,00", semJuros: true },
                  { parcelas: "7x", valor: "R$ 46,51", total: "R$ 325,57", semJuros: true },
                  { parcelas: "8x", valor: "R$ 41,08", total: "R$ 328,64", semJuros: true },
                  { parcelas: "9x", valor: "R$ 36,87", total: "R$ 331,83", semJuros: true },
                  { parcelas: "10x", valor: "R$ 33,50", total: "R$ 335,00", semJuros: true },
                  { parcelas: "11x", valor: "R$ 30,75", total: "R$ 338,25", semJuros: true },
                  { parcelas: "12x", valor: "R$ 28,46", total: "R$ 341,52", semJuros: true },
                ].map((item, index) => (
                  <div
                    key={index}
            ...
            <div className="flex-1 overflow-y-auto p-5 md:p-6">
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  "Personaliza foto e vídeos na tela do relógio",
                  ...
                  "Assistente de voz",
                  "Cronômetro",
                  "Music Player (Deezer, Spotify, etc.)",
                  "Jogos",
              ...
              <div className="bg-gray-900/80 border border-gray-800 rounded-2xl overflow-hidden flex flex-col">
                ...
                <div className="p-5 flex flex-col gap-3">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm line-through mt-0.5">R$428,37</p>
                    <div className="flex items-baseline gap-2 mt-0.5">
                      <span className="text-white text-3xl font-black">R$297,00</span>
                      <span className="bg-orange-500 text-white text-xs font-bold px-2 py-0.5 rounded-md">30% OFF</span>
                    </div>
                  </div>
                  <div className="text-sm text-gray-300 space-y-0.5">
                    <p>12x de R$28,46 sem juros</p>
                    <p className="text-green-400 font-semibold">R$285,00 via Pix</p>
                  </div>
                  <button
              ...
              <div className="mt-8">
                ...
                <div className="flex items-center justify-center gap-3 mb-6">
                  <span className="relative text-gray-500 text-sm font-medium">
                    +R$105,00
                    <span className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-px bg-red-500/70" />
                  </span>
                  <span className="text-gray-600 text-xs">em brindes</span>
                  <span className="h-4 w-px bg-white/10" />
                  <span className="text-green-400 text-sm font-bold tracking-widest uppercase">Grátis</span>
                </div>
        ...
        >
          <div className="bg-gray-900/60 backdrop-blur-md border border-gray-700/50 rounded-2xl md:rounded-3xl p-6 md:p-12 shadow-xl">
            ...
            <div className="flex justify-center mb-5 md:mb-6">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/valor2-IjKR6ESlM7tefy5ULILlep2hVXXOiw.webp"
                alt="Smartwatches Series 11 Ultra e Pro - De R$428,37 por apenas 12x de R$29,97 sem juros"
                width={400}
                height={500}
